...
from tensorflow.keras.layers import LeakyReLU, UpSampling2D, PReLU, ReLU
...
def Darknet_Depthwise_Separable_Conv2D_BN_Leaky(filters, kernel_size=(3, 3), block_id_str=None, **kwargs):
    ...
    return compose(
        ...
        ReLU(name='conv_dw_%s_leaky_relu' % block_id_str),
        ...
        ReLU(name='conv_pw_%s_leaky_relu' % block_id_str))
